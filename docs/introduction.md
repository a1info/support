# Uvod v Optima Prevent

## Kaj je Optima Prevent

Optima Prevent je celovit EHS (Environmental Health and Safety) sistem, ki je posebej prilagojen slovenski zakonodaji in mednarodnim standardom (OHSAS, ISO). Namenjen je organizacijam in strokovnim službam, ki se ukvarjajo z varnostjo in zdravjem pri delu (VZD), požarno varnostjo (PV) in varstvom okolja.
...
- Optimizira procese usposabljanja zaposlenih
...
Optima Prevent vključuje naslednje ključne module:

### 1. Upravljanje zaposlenih in usposabljanja

- Vodenje evidence zaposlenih
- Organizacija in sledenje usposabljanjem
- Oddaljeno e-usposabljanje s preverjanjem znanja
- Avtomatsko generiranje potrdil in zapisnikov

### 2. Delovna oprema

- Evidenca delovne opreme
- Pregledi in vzdrževanje
- QR kode za hitri dostop do informacij
- Zapisniki in poročila o pregledih

### 3. Ocene tveganj

- Izdelava in upravljanje ocen tveganja
- Tipična delovna mesta (TDM)
- Analiza tveganj in ukrepov
...
- Gasilna oprema
- Vaje evakuacije
- Odgovorne osebe za požarno varnost
...
Uporabniki strank dostopajo do sistema preko posebnega URL naslova in imajo prilagojen vmesnik, ki prikazuje samo podatke njihove organizacije.
