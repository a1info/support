...
V seznamu ocen telesnih obremenitev sta na voljo ikona **Dok. za stranko (PDF)** in ikona **DOCX** s spustnim seznamom predlog:
...
- Predloga, ki je bila **zadnjič uporabljena** za to oceno, je v seznamu označena s kljukico ✓.
